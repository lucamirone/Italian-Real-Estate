...
const propertyTypes = [
  ["Historic villas", "Legacy, UHNW, relocation, and cultural buyers.", "Architecture, gardens, history, privacy, and permanence.", "Title, preservation rules, systems, maintenance, access, and staffing.", "High", "Attorney, surveyor/geometra, architect, tax advisor, insurance advisor."],
  ["Countryside estates", "Lifestyle, legacy, privacy, and long-stay buyers.", "Land, quiet, views, food and wine, family gathering.", "Access, utilities, land obligations, road rights, maintenance, and services.", "Medium", "Attorney, geometra, architect, property manager, tax advisor."],
  ["Vineyards and wineries", "Legacy, lifestyle investment, hospitality, and agricultural buyers.", "Wine culture, land, brand potential, and family identity.", "Business operations, licenses, land use, staffing, production, and compliance.", "High", "Attorney, tax advisor, agricultural specialist, accountant, technical surveyor.", "assets/property-vineyards-wineries.png", "Italian winery estate with vineyard rows, arched cellar, barrels, tanks, and stone courtyard"],
  ["Lake homes", "Lifestyle, UHNW, family, and semi-retirement buyers.", "Views, water, services, privacy, and northern Italy access.", "Access, parking, lake rights, maintenance, exposure, and seasonal activity.", "Medium", "Attorney, surveyor/geometra, property manager, insurance advisor."],
  ["Coastal properties", "Lifestyle, hospitality, and seasonal buyers.", "Sea access, climate, views, and memorable family use.", "Permits, access, erosion or exposure, rental rules, maintenance, and parking.", "Medium", "Attorney, technical surveyor, insurance advisor, local property manager."],
  ...
  ["Restored farmhouses", "Lifestyle, countryside, family, and legacy buyers.", "Character, land, outdoor living, and authentic rural settings.", "Quality of restoration, utilities, road access, heating/cooling, and local services.", "Medium", "Attorney, geometra, architect, inspector, property manager."],
  ["Renovation properties", "Restoration buyers with time, patience, and risk tolerance.", "Creative control, historic character, and potential value creation.", "Budget realism, permits, contractors, structural condition, timeline, and utilities.", "High", "Attorney, architect, geometra, contractor, tax advisor, project manager."],
  ["Luxury estates", "UHNW, privacy, legacy, and service-oriented buyers.", "Privacy, scale, architectural significance, and rare location.", "Security, staffing, maintenance, technical systems, title, and ownership structure.", "High", "Attorney, tax advisor, surveyor/geometra, architect, insurance, property manager."],
...
function renderStaticCards() {
  ...
  propertyGrid.innerHTML = propertyTypes.map(([name, fit, appeal, questions, complexity, verification, image, imageAlt]) => `
    <article class="property-card${image ? " property-card-with-image" : ""}">
      ${image ? `<img class="property-image" src="${escapeHtml(image)}" alt="${escapeHtml(imageAlt)}">` : ""}
      <h3>${escapeHtml(name)}</h3>
      <dl>
